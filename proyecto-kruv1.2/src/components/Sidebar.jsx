        ...
        <div className="box">
           <div style={{width: isOpen ? "50px":  "350px"}} className="sidebar">
               <div className="top_section">
                   <h1 style={{display: isOpen ? "none": "block"  ,marginLeft: isOpen ? "0px" : "70px"}} className="logo">
                        <img src={"https://www.nuevarevista.net/wp-content/uploads/2018/04/icono-phone-100x100.png"} /></h1>
